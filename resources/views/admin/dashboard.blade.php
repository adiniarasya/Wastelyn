            ...
            <div class="mt-6 bg-white rounded-xl shadow-md p-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                    <a href="#" class="bg-green-50 hover:bg-green-100 p-4 rounded-lg text-center transition">
                        ...
                        <span class="text-sm font-medium text-gray-700">Kelola Warga</span>
                    </a>
                    ...
                    <a href="#" class="bg-yellow-50 hover:bg-yellow-100 p-4 rounded-lg text-center transition">
                        <div class="text-2xl mb-1">🎯</div>
                        <span class="text-sm font-medium text-gray-700">Kelola Misi</span>
                    </a>
                    <a href="#" class="bg-purple-50 hover:bg-purple-100 p-4 rounded-lg text-center transition">
                        <div class="text-2xl mb-1">🎁</div>
                        <span class="text-sm font-medium text-gray-700">Kelola Reward</span>
                    </a>
                </div>
            </div>
        </div>
