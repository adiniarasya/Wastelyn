                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('target', $mission->target) }}"
                                        min="1"
                                        required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('reward_xp', $mission->reward_xp) }}"
                                        min="0"
                                        required>
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="status"
                                        ...
                                        <option value="active"
                                            {{ old('status', $mission->status) == 'active' ? 'selected' : '' }}>
                                            Aktif
                                        </option>

                                        <option value="inactive"
                                            {{ old('status', $mission->status) == 'inactive' ? 'selected' : '' }}>
                                            Nonaktif
                                        </option>
